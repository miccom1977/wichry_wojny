...
(function ($) {
    ...
    Jconfirm.prototype = {
        ...
        _buildHTML: function () {
             ...
             */
            this.setTitle();
            this.contentDiv = this.$el.find('div.contentAlert');
        ...
        setTitle: function(string){
            ...
            if (this.title) {
                this.$el.find('div.titleAlert').html('<i class="' + this.icon + '"></i> ' + this.title);
            } else {
                this.$el.find('div.titleAlert').remove();
            }
        },
    ...
    jconfirm.pluginDefaults = {
        template: '<div class="jconfirm"><div class="jconfirm-box"><div class="titleAlert"></div><div class="contentAlert"></div><div class="buttons"></div><div class="jquery-clear"></div></div>',
        title: 'Hello',
