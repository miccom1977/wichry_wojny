...
$.fn.jAlert = function(options) {
	...
	var showJAlert = function(content){
		...
		div += "><div>";
		/* If close button */
  		if(options.closeBtn){ div += "<div class='closeAlert jClose'></div>"; }
  		/* Add content */
  		div += '<div id="srobka_left_up"></div><div id="icon_alert"></div><p class="p_alert">'+content+'</p><div id="srobka_right_down"></div>';
  		/* Open button wrapper */
